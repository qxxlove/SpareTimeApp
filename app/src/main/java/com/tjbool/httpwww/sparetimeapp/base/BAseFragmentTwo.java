...
/** 
 * description: 满足Viewpager嵌套Fragment以及嵌套二级Viewpager+fragemnt
 * autour: TMM
 * date: 2018/5/16 14:01 
 * update: 2018/5/16
 * version: 
*/
...
public abstract class BAseFragmentTwo extends Fragment {
    ...
    public void onHiddenChanged(boolean hidden) {
        ...
        Log.e("BAseFragmentTwo",getClass().getSimpleName() + "  onHiddenChanged dispatchChildVisibleState  hidden " + hidden);
    ...
    private boolean isParentInvisible() {
        ...
        if (parentFragment instanceof BAseFragmentTwo ) {
            BAseFragmentTwo fragment = (BAseFragmentTwo) parentFragment;
    ...
    private void dispatchChildVisibleState(boolean visible) {
        ...
        if (!fragments.isEmpty()) {
            for (Fragment child : fragments) {
                if (child instanceof BAseFragmentTwo && !child.isHidden() && child.getUserVisibleHint()) {
                    ((BAseFragmentTwo) child).dispatchUserVisibleHint(visible);
                }
            }
        }
    }
    ...
    public void onFragmentFirstVisible() {
        Log.e("BAseFragmentTwo",getClass().getSimpleName() + "  对用户第一次可见");

    }

    public void onFragmentResume() {
        Log.e("BAseFragmentTwo",getClass().getSimpleName() + "  对用户可见");
    }

    public void onFragmentPause() {
        Log.e("BAseFragmentTwo",getClass().getSimpleName() + "  对用户不可见");
    }
