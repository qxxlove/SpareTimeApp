...
public class MyCricleView   extends View {
    ...
    public MyCricleView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public MyCricleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
