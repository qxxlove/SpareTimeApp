...
public class TemperatureView extends View {
    ...
    private String[] mNumber = {"40", "30", "20", "10", "0", "-10", "-20"};
    private float mProgress;
    private int mValueColor = Color.RED;
    private float mValueSize = 36;


    private List<StudentBean>  listOne ;

    private List<StudentBean>  listTwo ;
    private List<StudentBean>  listThree ;
    private List<StudentBean>  listFour ;
    ...
    public  void   setListOne   (List<StudentBean>  listOne){
        this.listOne = listOne ;
        Log.d("大1小",listOne.size()+"");
    }

    public  void   setListTwo   (List<StudentBean>  listOne){
        this.listTwo = listOne ;
        Log.d("大1小",listOne.size()+"");
    }
    public  void   setListThree   (List<StudentBean>  listOne){
        this.listThree = listOne ;
        Log.d("大1小",listOne.size()+"");
    }
    public  void   setListFour   (List<StudentBean>  listOne){
        this.listFour = listOne ;
        Log.d("大1小",listOne.size()+"");
    }
